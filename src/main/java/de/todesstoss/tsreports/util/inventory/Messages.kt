...
enum class Messages(
    ...
    GUI_REPORTPLAYER_PLAYER_NAME("gui.reportPlayer.player.name"),
    GUI_REPORTPLAYER_PLAYER_LORE("gui.reportPlayer.player.lore"),
    ...
    GUI_REPORTPLAYER_CONFIRM_LORE("gui.reportPlayer.confirm.lore"),
